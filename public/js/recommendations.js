    ...
    const sectionHTML = `
      <div class="recommendations-overview">
        ...
        <div class="recommendations-preview">
          ${data.contentBased.slice(0, 3).map(rec => createRecommendationCard(rec)).join('')}
        </div>
    ...
    <div class="card">
      <div class="card__header">
        <div class="card__picture">
          ...
          <img class="card__picture-img" src="/img/tours/${rec.tour.imageCover}" alt="${rec.tour.name}">
        </div>
      ...
      <div class="card__details">
        <h4 class="card__sub-heading">${rec.tour.difficulty} ${rec.tour.duration}-day tour</h4>
        ...
        <div class="card__data">
          ...
          <span>${new Date(rec.tour.startDates[0]).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</span>
        </div>
        <div class="card__data">
          <svg class="card__icon">
      ...
      <div class="card__footer">
        ...
        <p class="card__ratings">
          ...
          <span class="card__footer-text">rating (${rec.tour.ratingsQuantity})</span>
        </p>
        <div class="recommendation-badge recommendation-badge--small">
          ${Math.round(rec.similarity * 100)}% match
        </div>
        <a class="btn btn--green btn--small" href="/tour/${rec.tour.slug}">Details</a>
      </div>
    </div>
  `;
};
